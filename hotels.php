...
<?php include 'nav.php'; ?>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/cover-img-10.jpg);">
					...
					<div class="col-md-9">
						<div class="row">
			                ...
			                <?php
						        ...
						        $total_pages_sql = "SELECT COUNT(*) FROM hotels where deletedAt is NULL";
						        $result = mysqli_query($conn,$total_pages_sql);
						        $total_rows = mysqli_fetch_array($result)[0];
						        $total_pages = ceil($total_rows / $no_of_records_per_page);

			                    $statement="select * from hotels where deletedAt is null order by hotel_id asc LIMIT $offset, $no_of_records_per_page";
