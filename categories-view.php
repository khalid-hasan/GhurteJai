...
<html>
	...
	<title>Category Wise Posts</title>
					...
					<div class="col-md-8">
						<div class="wrap-division">
							...
							<?php
						        ...
						        $total_pages_sql = "SELECT COUNT(*) FROM posts where deletedAt is NULL and cat_id='$_SESSION[cat_id]' ";
						        $result = mysqli_query($conn,$total_pages_sql);
						        $total_rows = mysqli_fetch_array($result)[0];
						        $total_pages = ceil($total_rows / $no_of_records_per_page);

							    $statement="SELECT * from posts where deletedAt is NULL and cat_id='$_SESSION[cat_id]' LIMIT $offset, $no_of_records_per_page";
			                    ...
			                    if (mysqli_num_rows($res_data) > 0)
			                    {
			                        while($row = mysqli_fetch_assoc($res_data))
			                        {
										...
										echo "<div class=\"blog-entry-side\">";
											echo "<a href=\"blog.html\" class=\"blog-post\">";
