...
<?php
  require 'config.php';
  $query=mysqli_query($conn, "SELECT COUNT(*) as count FROM hotels WHERE deletedAt is NULL");
...
<?php
  require 'config.php';
  $query=mysqli_query($conn, "SELECT COUNT(*) as count FROM tours WHERE deletedAt is NULL");
  $result= mysqli_fetch_assoc($query);
  $value= $result['count'];
?>
              <h3><?php echo $value; ?></h3>
...
<?php
  require 'config.php';
  $query=mysqli_query($conn, "SELECT COUNT(*) as count FROM users WHERE deletedAt is NULL");
  $result= mysqli_fetch_assoc($query);
  $value= $result['count'];
?>
              <h3><?php echo $value; ?></h3>
...
<?php
  require 'config.php';
  $query=mysqli_query($conn, "SELECT COUNT(*) as count FROM posts WHERE deletedAt is NULL");
  $result= mysqli_fetch_assoc($query);
  $value= $result['count'];
?>
              <h3><?php echo $value; ?></h3>
